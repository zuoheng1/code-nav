export default {
  ...
  keyContentMap: {
    myLike: [
      {
        icon:
          'https://tse3-mm.cn.bing.net/th/id/OIP-C.RwlIZ_d6kaOqtcL_XDFjpwHaG1?pid=ImgDet&rs=1',
        link: 'http://gitlab.yiwise.local/dashboard/activity',
        name: 'yiwise-local',
      },
      {
        icon:
      ...
      {
        icon:
          'https://636f-codenav-8grj8px727565176-1256524210.tcb.qcloud.la/img/1610687108091-favicon_new.png',
